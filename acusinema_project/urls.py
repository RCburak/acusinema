...
urlpatterns = [
    ...
    path('my-reservations/', core_views.my_reservations_view, name='my_reservations'),
    path('reserve-event/<int:event_id>/', core_views.create_reservation_view, name='create_reservation'),
]
